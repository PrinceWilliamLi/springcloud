...
@MapperScan(value = "com.prince.product.mapper")
public class PrinceProductApplication {

    public static void main(String[] args) {
        SpringApplication.run(PrinceProductApplication.class, args);
    }
